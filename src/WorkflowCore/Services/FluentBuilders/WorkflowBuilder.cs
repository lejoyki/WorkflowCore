...
namespace WorkflowCore.Services
{
    public class WorkflowBuilder : IWorkflowBuilder
    {
        ...
        protected WorkflowErrorHandling DefaultErrorBehavior = WorkflowErrorHandling.Suspend;
    ...
    public class WorkflowBuilder<TData> : WorkflowBuilder, IWorkflowBuilder<TData>
    {
        ...
        {
            return Start().WaitFor(eventName, eventKey, effectiveDate);
        }
        ...
        {
            return ((IWorkflowModifier<TData, InlineStepBody>) Start()).When(outcomeValue);
        }
